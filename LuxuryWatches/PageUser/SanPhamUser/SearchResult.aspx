<%@ Page Title="" Language="C#" MasterPageFile="~/PageUser/Site1.Master" AutoEventWireup="true" CodeBehind="SearchResult.aspx.cs" Inherits="LuxuryWatches.PageUser.SanPhamUser.SearchResult" %>

<%@ Register Src="~/PageUser/User_Control/LocTheoHSX.ascx" TagPrefix="uc1" TagName="LocTheoHSX" %>
<%@ Register Src="~/PageUser/User_Control/LocTheoHSX.ascx" TagPrefix="uc1" TagName="LocTheoLoaiSP" %>
