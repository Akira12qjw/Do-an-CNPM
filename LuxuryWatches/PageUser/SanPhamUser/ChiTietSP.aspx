<%@ Page Title="" Language="C#" MasterPageFile="~/PageUser/Site1.Master" AutoEventWireup="true" CodeBehind="ChiTietSP.aspx.cs" Inherits="LuxuryWatches.PageUser.SanPhamUser.ChiTietSP" %>


<%@ Register Src="~/PageUser/User_Control/LocTheoLoaiSP.ascx" TagPrefix="uc1" TagName="LocTheoLoaiSP" %>
<%@ Register Src="~/PageUser/User_Control/LocTheoHSX.ascx" TagPrefix="uc1" TagName="LocTheoHSX" %>
                                        ...
                                        <div class="product-one">
                                            <asp:Repeater ID="Repeater1" ItemType="LuxuryWatches.Data.sanPham" SelectMethod="LaySanPhamLienQuan" runat="server">
                                                ...
                                                <div class="product-main simpleCart_shelfItem">
                                                    <a href="<%# GetRouteUrl("chitietspUser",new { masp = Eval("maSP"), bidanh = Eval("biDanh") }) %>" class="mask"><img class="img-responsive zoom-img" src='/photos/<%# Eval("hinhDaiDien") %>' alt="" /></a>
                                                    <div class="product-bottom">
                                                        <h3><%# Eval("tenSP") %></h3>
                                                        <p>Xem ngay</p>
                                                        <h4><a class="item_add" href="<%# GetRouteUrl("chitietspUser",new { masp = Eval("maSP"), bidanh = Eval("biDanh") }) %>"><i></i></a> <span class=" item_price"><%# Eval("giaBan","{0:#,##0}").Replace(',','.') %> đ</span></h4>
                                                    </div>
                                                    <div class="srch">
