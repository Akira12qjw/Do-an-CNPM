<%@ Page Title="Giỏ hàng" Language="C#" MasterPageFile="~/PageUser/Site1.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="LuxuryWatches.PageUser.ShoppingUser.Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="breadcrumbs">
        <div class="container">
            <div class="breadcrumbs-main">
                <ol class="breadcrumb">
                    <li><a href="../../Userlg.aspx">Trang chủ</a></li>
    ...
    <div class="ckeckout">
        <div class="container">
            <% if (Session["shoppinguser"] == null || (Session["shoppinguser"] as List<LuxuryWatches.Data.CartItem>).Count == 0)
                {%>
            ...
            if (result.status == 1) {
                ...
                console.log("Lỗi ajax!");
                    ...
                    <div class="in-check">
                        ...
                        <asp:Repeater ID="repeaterGioHang" runat="server" SelectMethod="GetShoppingUser" ItemType="LuxuryWatches.Data.CartItem">
                            <ItemTemplate>
                                <ul class="cart-header">
                                    ...
                                    <li class="ring-in"><a target="_blank" href="<%# GetRouteUrl("chitietspUser",new { bidanh = Eval("biDanh"), maSP = Eval("maSP") }) %>"><%# Eval("tenSP") %></a>
                                    </li>
                        ...
                        <ul class="cart-header">
                            ...
                            <li style="width: 25%">
                                <span class="cost">Tổng số lượng:
                                    <label id="tongsoluong"><%: (Session["shoppinguser"] as List<LuxuryWatches.Data.CartItem>).Sum(m=>m.soLuong) %></label></span> </li>

                            <li style="width: 25%"><span class="cost">Tổng thành tiền:
                                <label id="tongthanhtien"><%: (Session["shoppinguser"] as List<LuxuryWatches.Data.CartItem>).Sum(m=>m.thanhTien).ToString("#,##0").Replace(',','.') %></label>
                                đ</span> </li>
                            <li></li>
                            <li></li>
                            <li></li>
